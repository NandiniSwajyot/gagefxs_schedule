...
import ChallanMgmt from "../Components/Admin/ChallanMgmt";
import GagePrices from "../Components/Admin/GagePrices";
    ...
    <Routes>
      ...
      <Route element={<Layout />}>
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["ADMIN", "IT_ADMIN", "CALIBRATION_MANAGER"]}>
        ...
        <Route
          path="/admin/challan"
          element={
            <ProtectedRoute allowedRoles={["ADMIN","ACC_MANAGER"]}>
              <ChallanMgmt />
            </ProtectedRoute>
          }
        />
        <Route
          path="/admin/gageprices"
          element={
            <ProtectedRoute allowedRoles={["ADMIN","ACC_MANAGER"]}>
              <GagePrices />
            </ProtectedRoute>
